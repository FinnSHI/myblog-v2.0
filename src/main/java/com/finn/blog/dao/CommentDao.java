...
public interface CommentDao extends BaseMapper<Comment> {
    ...
    /*
    * @Description: 查看评论
    * @Param: [current, size, commentVO]
    * @return: java.util.List<com.finn.blog.dto.CommentDTO>
    * @Author: Finn
    ...
    */
    ...
    /*
    * @Description: 查看评论id集合下的回复
    * @Param: [commentIdList]
    * @return: java.util.List<com.finn.blog.dto.ReplyDTO>
    * @Author: Finn
