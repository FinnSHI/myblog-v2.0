...
import com.finn.blog.entity.ArticleTag;
...
import com.finn.blog.service.ArticleTagService;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleDao, Article> implements ArticleService {
    ...
    * @Description: 保存文章分类
    * @Param: [articleVO]
    * @return: com.finn.blog.entity.Category
    * @Author: Finn
    * @Date: 2022/04/04 21:35
    */
